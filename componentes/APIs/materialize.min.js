...
"undefined" == typeof jQuery && ("function" == typeof require ? jQuery = $ = require("jquery") : jQuery = $),
	function (t) {
		...
		return function (t, e, i, n) {
			...
			function r(t, i, n, o) {
				...
				function u(e) {
					for (var i = 0, o = 1, a = m - 1; o != a && w[o] <= e; ++o) i += g;
					var r = i + (e - w[--o]) / (w[o + 1] - w[o]) * g,
						s = c(r, t, n);
					return s >= h ? function (e, i) {
						...
						return i
					}(e, r) : 0 == s ? r : function (e, i, o) {
						var a, r, s = 0;
						do {
							(a = l(r = i + (o - i) / 2, t, n) - e) > 0 ? o = r : i = r
						} while (Math.abs(a) > f && ++s < v);
						return r
					}(e, i, i + g)
				}
				...
				function d() {
					k = !0, (t != i || n != o) && function () {
						for (var e = 0; m > e; ++e) w[e] = l(e * g, t, n)
					}()
				}
				var p = 4,
					h = .001,
				...
				var w = y ? new Float32Array(m) : new Array(m),
					k = !1,
					x = function (e) {
						return k || d(), t === i && n === o ? e : 0 === e ? 0 : 1 === e ? 1 : l(u(e), i, o)
					};
			...
			function s(t, e) {
				var i = t;
				return h.isString(t) ? g.Easings[t] || (i = !1) : i = h.isArray(t) && 1 === t.length ? function (t) {
					return function (e) {
						return Math.round(e * t) * (1 / t)
					}
				}.apply(null, t) : h.isArray(t) && 2 === t.length ? y.apply(null, t.concat([e])) : !(!h.isArray(t) || 4 !== t.length) && r.apply(null, t), !1 === i && (i = g.Easings[g.defaults.easing] ? g.defaults.easing : m), i
			}
				...
				if (t) {
					...
					for (var o = 0; i > o; o++)
						if (g.State.calls[o]) {
							...
							for (var m = Math.min((e - p) / d.duration, 1), y = 0, w = s.length; w > y; y++) {
								var x = s[y],
									C = x.element;
								if (a(C)) {
									var T = !1;
									...
									for (var S in d.visibility !== n && "hidden" !== d.visibility && b.setPropertyValue(C, "visibility", d.visibility), x)
										if ("element" !== S) {
											var P, A = x[S],
												O = h.isString(A.easing) ? g.Easings[A.easing] : A.easing;
											if (1 === m) P = A.endValue;
											else {
												var E = A.endValue - A.startValue;
												if (P = A.startValue + E * O(m, d, E), !f && P === A.currentValue) continue
											}
											if (A.currentValue = P, "tween" === S) v = P;
											else {
												if (b.Hooks.registered[S]) {
													var _ = b.Hooks.getRoot(S),
														M = a(C).rootPropertyValueCache[_];
													M && (A.rootPropertyValue = M)
												}
												var I = b.setPropertyValue(C, S, A.currentValue + (0 === parseFloat(P) ? "" : A.unitType), A.rootPropertyValue, A.scrollData);
												b.Hooks.registered[S] && (a(C).rootPropertyValueCache[_] = b.Normalizations.registered[_] ? b.Normalizations.registered[_]("extract", null, I[1]) : I[1]), "transform" === I[0] && (T = !0)
											}
										}
									d.mobileHA && a(C).transformCache.translate3d === n && (a(C).transformCache.translate3d = "(0px, 0px, 0px)", T = !0), T && b.flushTransformCache(C)
								}
							}
							d.display !== n && "none" !== d.display && (g.State.calls[o][2].display = !1), d.visibility !== n && "hidden" !== d.visibility && (g.State.calls[o][2].visibility = !1), d.progress && d.progress.call(r[1], r[1], m, Math.max(0, p + d.duration - e), p, v), 1 === m && c(o)
						}
				}
			...
			function c(t, e) {
				...
				for (var i = g.State.calls[t][0], o = g.State.calls[t][1], r = g.State.calls[t][2], s = g.State.calls[t][4], l = !1, c = 0, d = i.length; d > c; c++) {
					var p = i[c].element;
					if (e || r.loop || ("none" === r.display && b.setPropertyValue(p, "display", r.display), "hidden" === r.visibility && b.setPropertyValue(p, "visibility", r.visibility)), !0 !== r.loop && (u.queue(p)[1] === n || !/\.velocityQueueEntryFlag/i.test(u.queue(p)[1])) && a(p)) {
						a(p).isAnimating = !1, a(p).rootPropertyValueCache = {};
						var h = !1;
						u.each(b.Lists.transforms3D, function (t, e) {
							var i = /^scale/.test(e) ? 1 : 0,
								o = a(p).transformCache[e];
							a(p).transformCache[e] !== n && new RegExp("^\\(" + i + "[^.]").test(o) && (h = !0, delete a(p).transformCache[e])
					...
					s && !0 !== r.loop && s(o), a(p) && !0 === r.loop && !e && (u.each(a(p).tweensContainer, function (t, e) {
			...
			if (!(7 >= d)) {
				...
				var b = g.CSS = {
					...
					Hooks: {
						...
						register: function () {
							for (a = 0; a < b.Lists.colors.length; a++) {
								var t = "color" === b.Lists.colors[a] ? "0 0 0 1" : "255 255 255 1";
								b.Hooks.templates[b.Lists.colors[a]] = ["Red Green Blue Alpha", t]
							}
							var e, i, n;
							if (d)
							...
							for (e in b.Hooks.templates)
								for (var a in n = (i = b.Hooks.templates[e])[0].split(" ")) {
									var r = e + n[a],
										s = a;
									b.Hooks.registered[r] = [e, s]
								}
						},
						getRoot: function (t) {
					...
					Normalizations: {
						...
						register: function () {
							for (9 >= d || g.State.isGingerbread || (b.Lists.transformsBase = b.Lists.transformsBase.concat(b.Lists.transforms3D)), t = 0; t < b.Lists.transformsBase.length; t++) ! function () {
						...
						prefixCheck: function (t) {
							...
							for (var e = ["", "Webkit", "Moz", "ms", "O"], i = 0, n = e.length; n > i; i++) {
								...
								if (o = 0 === i ? t : e[i] + t.replace(/^\w/, function (t) {
									...
									}), h.isString(g.State.prefixElement.style[o])) return g.State.prefixMatches[t] = o, [o, !0]
							}
							return [t, !1]
						}
					},
					...
					getPropertyValue: function (t, i, o, r) {
						function s(t, i) {
							function o() {
								p && b.setPropertyValue(t, "display", "none")
							}
							var l = 0;
							if (8 >= d) l = u.css(t, i);
							else {
								var c, p = !1;
								if (/^(width|height)$/.test(i) && 0 === b.getPropertyValue(t, "display") && (p = !0, b.setPropertyValue(t, "display", b.Values.getDisplayType(t))), !r) {
						...
						if (b.Hooks.registered[i]) {
							var c = i,
								p = b.Hooks.getRoot(c);
							o === n && (o = b.getPropertyValue(t, b.Names.prefixCheck(p)[0])), b.Normalizations.registered[p] && (o = b.Normalizations.registered[p]("extract", t, o)), l = b.Hooks.extractValue(c, o)
						} else if (b.Normalizations.registered[i]) {
							var h, f;
							"transform" !== (h = b.Normalizations.registered[i]("name", t)) && (f = s(t, b.Names.prefixCheck(h)[0]), b.Values.isCSSNullValue(f) && b.Hooks.templates[i] && (f = b.Hooks.templates[i][1])), l = b.Normalizations.registered[i]("extract", t, f)
						}
						if (!/^[\d-]/.test(l))
				...
				b.Hooks.register(), b.Normalizations.register(), g.hook = function (t, e, i) {
					var r = n;
				...
				var w = function () {
					...
					function r() {
						function t(t) {
							function p(t, e) {
								var i = n,
									o = n,
									a = n;
								return h.isArray(t) ? (i = t[0], !h.isArray(t[1]) && /^[\d-]/.test(t[1]) || h.isFunction(t[1]) || b.RegEx.isHex.test(t[1]) ? a = t[1] : (h.isString(t[1]) && !b.RegEx.isHex.test(t[1]) || h.isArray(t[1])) && (o = e ? t[1] : s(t[1], c.duration), t[2] !== n && (a = t[2]))) : i = t, e || (o = o || c.easing), h.isFunction(i) && (i = i.call(r, T, C)), h.isFunction(a) && (a = a.call(r, T, C)), [i || 0, o, a]
							}
							...
							if ("scroll" === P) {
								var v, w, x, S = /^x$/i.test(c.axis) ? "Left" : "Top",
									O = parseFloat(c.offset) || 0;
								c.container ? h.isWrapped(c.container) || h.isNode(c.container) ? (c.container = c.container[0] || c.container, x = (v = c.container["scroll" + S]) + u(r).position()[S.toLowerCase()] + O) : c.container = null : (v = g.State.scrollAnchor[g.State["scrollProperty" + S]], w = g.State.scrollAnchor[g.State["scrollProperty" + ("Left" === S ? "Top" : "Left")]], x = u(r).offset()[S.toLowerCase()] + O), d = {
									scroll: {
										rootPropertyValue: !1,
										startValue: v,
										currentValue: v,
								...
								for (var E in "none" === a(r).opts.display && (a(r).opts.display = "auto"), "hidden" === a(r).opts.visibility && (a(r).opts.visibility = "visible"), a(r).opts.loop = !1, a(r).opts.begin = null, a(r).opts.complete = null, k.easing || delete c.easing, k.duration || delete c.duration, c = u.extend({}, a(r).opts, c), M = u.extend(!0, {}, a(r).tweensContainer))
									if ("element" !== E) {
										var _ = M[E].startValue;
										M[E].startValue = M[E].currentValue = M[E].endValue, M[E].endValue = _, h.isEmptyObject(k) || (M[E].easing = c.easing), g.debug && console.log("reverse tweensContainer (" + E + "): " + JSON.stringify(M[E]), r)
									}
								d = M
							} else if ("start" === P) {
								var M;
								for (var q in a(r).tweensContainer && !0 === a(r).isAnimating && (M = a(r).tweensContainer), u.each(y, function (t, e) {
									...
									var z = p(y[q]),
										...
										H = z[1],
										L = z[2];
									q = b.Names.camelCase(q);
									var j = b.Hooks.getRoot(q),
										$ = !1;
									if (a(r).isSVG || "tween" === j || !1 !== b.Names.prefixCheck(j)[1] || b.Normalizations.registered[j] !== n) {
										(c.display !== n && null !== c.display && "none" !== c.display || c.visibility !== n && "hidden" !== c.visibility) && /opacity|filter/.test(q) && !L && 0 !== V && (L = 0), c._cacheValues && M && M[q] ? (L === n && (L = M[q].endValue + M[q].unitType), $ = a(r).rootPropertyValueCache[j]) : b.Hooks.registered[q] ? L === n ? ($ = b.getPropertyValue(r, j), L = b.getPropertyValue(r, q, $)) : $ = b.Hooks.templates[j][1] : L === n && (L = b.getPropertyValue(r, q));
										var N, W, F, Q = !1;
										if (L = (N = f(q, L))[0], F = N[1], V = (N = f(q, V))[0].replace(/^([+-\/*])=/, function (t, e) {
												return Q = e, ""
											...
											if (0 === V) W = F;
												...
												o = o || function () {
													...
													if (o && n) l.emToPx = I.lastEmToPx, l.percentToPxWidth = I.lastPercentToPxWidth, l.percentToPxHeight = I.lastPercentToPxHeight;
														...
														}), g.CSS.setPropertyValue(c, "paddingLeft", s + "em"), l.percentToPxWidth = I.lastPercentToPxWidth = (parseFloat(b.getPropertyValue(c, "width", null, !0)) || 1) / s, l.percentToPxHeight = I.lastPercentToPxHeight = (parseFloat(b.getPropertyValue(c, "height", null, !0)) || 1) / s, l.emToPx = I.lastEmToPx = (parseFloat(b.getPropertyValue(c, "paddingLeft")) || 1) / s, t.myParent.removeChild(c)
													}
													return null === I.remToPx && (I.remToPx = parseFloat(b.getPropertyValue(i.body, "fontSize")) || 16), null === I.vwToPx && (I.vwToPx = parseFloat(e.innerWidth) / 100, I.vhToPx = parseFloat(e.innerHeight) / 100), l.remToPx = I.remToPx, l.vwToPx = I.vwToPx, l.vhToPx = I.vhToPx, g.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), r), l
												}();
										...
										d[q] = {
											...
											unitType: W,
											easing: H
										}, g.debug && console.log("tweensContainer (" + q + "): " + JSON.stringify(d[q]), r)
									} else g.debug && console.log("Skipping [" + j + "] due to a lack of browser support.")
								}
								d.element = r
							}
							d.element && (b.Values.addClass(r, "velocity-animating"), D.push(d), "" === c.queue && (a(r).tweensContainer = d, a(r).opts = c), a(r).isAnimating = !0, T === C - 1 ? (g.State.calls.push([D, m, c, null, A.resolver]), !1 === g.State.isTicking && (g.State.isTicking = !0, l())) : T++)
						}
						var o, r = this,
						...
						switch (a(r) === n && g.init(r), parseFloat(c.delay) && !1 !== c.queue && u.queue(r, c.queue, function (t) {
							...
							return !0 === i ? (A.promise && A.resolver(m), !0) : (g.velocityQueueEntryFlag = !0, void t(e))
						}), "" !== c.queue && "fx" !== c.queue || "inprogress" === u.queue(r)[0] || u.dequeue(r)
					}
					var d, p, f, m, y, k, x = arguments[0] && (arguments[0].p || u.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || h.isString(arguments[0].properties));
					if (h.isWrapped(this) ? (d = !1, f = 0, m = this, p = this) : (d = !0, f = 1, m = x ? arguments[0].elements || arguments[0].e : arguments[0]), m = o(m)) {
						x ? (y = arguments[0].properties || arguments[0].p, k = arguments[0].options || arguments[0].o) : (y = arguments[f], k = arguments[f + 1]);
						var C = m.length,
							T = 0;
						if (!/^(stop|finish)$/i.test(y) && !u.isPlainObject(k)) {
							k = {};
							for (var S = f + 1; S < arguments.length; S++) h.isArray(arguments[S]) || !/^(fast|normal|slow)$/i.test(arguments[S]) && !/^\d/.test(arguments[S]) ? h.isString(arguments[S]) || h.isArray(arguments[S]) ? k.easing = arguments[S] : h.isFunction(arguments[S]) && (k.complete = arguments[S]) : k.duration = arguments[S]
						}
						var P, A = {
							promise: null,
							resolver: null,
						...
						switch (d && g.Promise && (A.promise = new g.Promise(function (t, e) {
							...
							case "stop":
								...
								return u.each(g.State.calls, function (t, e) {
									e && u.each(e[1], function (i, o) {
										var r = k === n ? "" : k;
										return !0 !== r && e[2].queue !== r && (k !== n || !1 !== e[2].queue) || void u.each(m, function (i, n) {
											n === o && ((!0 === k || h.isString(k)) && (u.each(u.queue(n, h.isString(k) ? k : ""), function (t, e) {
												h.isFunction(e) && e(null, !0)
											}), u.queue(n, h.isString(k) ? k : "", [])), "stop" === y ? (a(n) && a(n).tweensContainer && !1 !== r && u.each(a(n).tweensContainer, function (t, e) {
												e.endValue = e.currentValue
											}), O.push(t)) : "finish" === y && (e[2].duration = 1))
										})
									})
								}), "stop" === y && (u.each(O, function (t, e) {
									c(e, !0)
								}), A.promise && A.resolver(m)), t();
							default:
								if (!u.isPlainObject(y) || h.isEmptyObject(y)) {
									if (h.isString(y) && g.Redirects[y]) {
										var E = (z = u.extend({}, k)).duration,
											_ = z.delay || 0;
										return !0 === z.backwards && (m = u.extend(!0, [], m).reverse()), u.each(m, function (t, e) {
											parseFloat(z.stagger) ? z.delay = _ + parseFloat(z.stagger) * t : h.isFunction(z.stagger) && (z.delay = _ + z.stagger.call(e, t, C)), z.drag && (z.duration = parseFloat(E) || (/^(callout|transition)/.test(y) ? 1e3 : v), z.duration = Math.max(z.duration * (z.backwards ? 1 - t / C : (t + 1) / C), .75 * z.duration, 200)), g.Redirects[y].call(e, e, z || {}, t, C, m, A.promise ? A : n)
										}), t()
									}
									var M = "Velocity: First argument (" + y + ") was not a property map, a known action, or a registered redirect. Aborting.";
									return A.promise ? A.rejecter(new Error(M)) : console.log(M), t()
								}
								P = "start"
						}
						var I = {
						...
						if (z.loop = parseInt(z.loop), q = 2 * z.loop - 1, z.loop)
							for (var V = 0; q > V; V++) {
								...
								V === q - 1 && (H.display = z.display, H.visibility = z.visibility, H.complete = z.complete), w(m, "reverse", H)
							}
						return t()
					}
				};
				...
				return g.State.isMobile || i.hidden === n || i.addEventListener("visibilitychange", function () {
					...
					}, l()) : k = e.requestAnimationFrame || p
				}), t.Velocity = g, t !== e && (t.fn.velocity = w, t.fn.velocity.defaults = g.defaults), u.each(["Down", "Up"], function (t, e) {
	...
	function (t, e, i, n) {
		...
		function k(t, e) {
			for (var i, o, a = e[0].toUpperCase() + e.slice(1), r = 0; r < Z.length;) {
				if ((o = (i = Z[r]) ? i + a : e) in t) return o;
				r++
			}
			return n
		}
		...
		function T(t, e, i) {
			var n = i.pointers.length,
				...
				a = e & ut && 0 == n - o,
				r = e & (pt | ht) && 0 == n - o;
			i.isFirst = !!a, i.isFinal = !!r, a && (t.session = {}), i.eventType = e,
				function (t, e) {
					var i = t.session,
						n = e.pointers,
						o = n.length;
					...
					var a = i.firstInput,
						...
						l = e.center = A(n);
					e.timeStamp = it(), e.deltaTime = e.timeStamp - a.timeStamp, e.angle = _(s, l), e.distance = E(s, l),
						function (t, e) {
							var i = e.center,
								n = t.offsetDelta || {},
								o = t.prevDelta || {},
								a = t.prevInput || {};
							(e.eventType === ut || a.eventType === pt) && (o = t.prevDelta = {
								x: a.deltaX || 0,
								y: a.deltaY || 0
							}, n = t.offsetDelta = {
								x: i.x,
						...
						}(i, e), e.offsetDirection = O(e.deltaX, e.deltaY), e.scale = r ? function (t, e) {
							return E(e[0], e[1], Ct) / E(t[0], t[1], Ct)
						}(r.pointers, n) : 1, e.rotation = r ? function (t, e) {
							return _(e[1], e[0], Ct) - _(t[1], t[0], Ct)
						}(r.pointers, n) : 0, S(i, e);
					var c = t.element;
		...
		function S(t, e) {
			...
			if (e.eventType != ht && (l > ct || s.velocity === n)) {
				...
				o = d.x, a = d.y, i = et(d.x) > et(d.y) ? d.x : d.y, r = O(c, u), t.lastInterval = e
		...
		function O(t, e) {
			return t === e ? ft : et(t) >= et(e) ? t > 0 ? vt : mt : e > 0 ? gt : yt
		}
		...
		function M() {
			this.evEl = St, this.evWin = Pt, this.allow = !0, this.pressed = !1, C.apply(this, arguments)
		}

		function I() {
			this.evEl = Et, this.evWin = _t, C.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
		}

		function D() {
			this.evTarget = It, this.evWin = Dt, this.started = !1, C.apply(this, arguments)
		}
		...
		function z() {
			...
			this.touch = new q(this.manager, t), this.mouse = new M(this.manager, t)
		}
		...
		function H(t) {
			this.id = nt++, this.manager = null, this.options = l(t || {}, this.defaults), this.options.enable = p(this.options.enable, !0), this.state = Qt, this.simultaneous = {}, this.requireFail = []
		}

		function L(t) {
			return t == yt ? "down" : t == gt ? "up" : t == vt ? "left" : t == mt ? "right" : ""
		}
		...
		function Y(t, e) {
			return (e = e || {}).recognizers = p(e.recognizers, Y.defaults.preset), new B(t, e)
		}

		function B(t, e) {
			e = e || {}, this.options = l(e, Y.defaults), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.element = t, this.input = function (t) {
				return new(t.options.inputClass || (at ? I : rt ? q : ot ? z : M))(t, T)
			}(this), this.touchAction = new V(this, this.options.touchAction), U(this, !0), r(e.recognizers, function (t) {
		...
		var Z = ["", "webkit", "moz", "MS", "ms", "o"],
			...
			at = k(t, "PointerEvent") !== n,
			rt = ot && /mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent),
			st = "touch",
			lt = "mouse",
			ct = 25,
			ut = 1,
		...
		c(M, C, {
			handler: function (t) {
				var e = Tt[t.type];
				e & ut && 0 === t.button && (this.pressed = !0), e & dt && 1 !== t.which && (e = pt), this.pressed && this.allow && (e & pt && (this.pressed = !1), this.callback(this.manager, e, {
					pointers: [t],
					changedPointers: [t],
					pointerType: lt,
					srcEvent: t
		...
		t.MSPointerEvent && (Et = "MSPointerDown", _t = "MSPointerMove MSPointerUp MSPointerCancel"), c(I, C, {
			handler: function (t) {
				var e = this.store,
					i = !1,
					n = t.type.toLowerCase().replace("ms", ""),
					o = At[n],
					a = Ot[t.pointerType] || t.pointerType,
					r = a == st,
					s = y(e, t.pointerId, "pointerId");
				o & ut && (0 === t.button || r) ? 0 > s && (e.push(t), s = e.length - 1) : o & (pt | ht) && (i = !0), 0 > s || (e[s] = t, this.callback(this.manager, o, {
					pointers: e,
					changedPointers: [t],
					pointerType: a,
					srcEvent: t
			...
			handler: function (t) {
				...
				if (e === ut && (this.started = !0), this.started) {
					var i = function (t, e) {
						...
						return e & (pt | ht) && (i = w(i.concat(n), "identifier", !0)), [i, n]
					}.call(this, t, e);
					e & (pt | ht) && 0 == i[0].length - i[1].length && (this.started = !1), this.callback(this.manager, e, {
						pointers: i[0],
						changedPointers: i[1],
						pointerType: st,
						srcEvent: t
		...
		c(q, C, {
			handler: function (t) {
				var e = qt[t.type],
					i = function (t, e) {
						var i = b(t.touches),
							n = this.targetIds;
						if (e & (ut | dt) && 1 === i.length) return n[i[0].identifier] = !0, [i, i];
						...
						for (o = 0; o < r.length;) n[r[o].identifier] && s.push(r[o]), e & (pt | ht) && delete n[r[o].identifier], o++;
			...
			handler: function (t, e, i) {
				...
				e & (pt | ht) && (this.mouse.allow = !0), this.callback(t, e, i)
			},
			destroy: function () {
				this.touch.destroy(), this.mouse.destroy()
			}
		});
		var Vt = k(J.style, "touchAction"),
			Ht = Vt !== n,
			Lt = "compute",
			jt = "auto",
			$t = "manipulation",
		...
		V.prototype = {
			set: function (t) {
				t == Lt && (t = this.compute()), Ht && (this.manager.element.style[Vt] = t), this.actions = t.toLowerCase().trim()
			},
			update: function () {
			...
			compute: function () {
				...
				return r(this.manager.recognizers, function (e) {
					...
					function (t) {
						...
						var e = m(t, Wt),
							i = m(t, Ft);
						return e && i ? Wt + " " + Ft : e || i ? e ? Wt : Ft : m(t, $t) ? $t : jt
					}(t.join(" "))
			},
			preventDefaults: function (t) {
				if (!Ht) {
					...
					var n = this.actions,
						...
						a = m(n, Ft),
						r = m(n, Wt);
					return o || a && i & bt || r && i & wt ? this.preventSrc(e) : void 0
				}
			},
		...
		H.prototype = {
			...
			requireFailure: function (t) {
				...
				return -1 === y(e, t = j(t, this)) && (e.push(t), t.requireFailure(this)), this
			},
			...
			emit: function (t) {
				function e(e) {
					i.manager.emit(i.options.event + (e ? function (t) {
						return t & Ut ? "cancel" : t & Yt ? "end" : t & Rt ? "move" : t & Xt ? "start" : ""
					}(n) : ""), t)
				}
				var i = this,
					n = this.state;
			...
			recognize: function (t) {
				var e = s({}, t);
				return d(this.options.enable, [this, e]) ? (this.state & (Bt | Ut | 32) && (this.state = Qt), this.state = this.process(e), void(this.state & (Xt | Rt | Yt | Ut) && this.tryEmit(e))) : (this.reset(), void(this.state = 32))
			},
			process: function () {},
			...
			process: function (t) {
				var e = this.state,
					...
					n = e & (Xt | Rt),
					o = this.attrTest(t);
				return n && (i & ht || !o) ? e | Ut : n || o ? i & pt ? e | Yt : e & Xt ? e | Rt : Xt : 32
			}
		}), c(N, $, {
			defaults: {
				event: "pan",
			...
			getTouchAction: function () {
				var t = this.options.direction,
					e = [];
				return t & bt && e.push(Ft), t & wt && e.push(Wt), e
			},
			directionTest: function (t) {
				var e = this.options,
					...
					a = t.deltaX,
					r = t.deltaY;
				return o & e.direction || (e.direction & bt ? (o = 0 === a ? ft : 0 > a ? vt : mt, i = a != this.pX, n = Math.abs(t.deltaX)) : (o = 0 === r ? ft : 0 > r ? gt : yt, i = r != this.pY, n = Math.abs(t.deltaY))), t.direction = o, i && n > e.threshold && o & e.direction
			},
			attrTest: function (t) {
				return $.prototype.attrTest.call(this, t) && (this.state & Xt || !(this.state & Xt) && this.directionTest(t))
			},
			emit: function (t) {
			...
			process: function (t) {
				...
				if (this._input = t, !n || !i || t.eventType & (pt | ht) && !a) this.reset();
				else if (t.eventType & ut) this.reset(), this._timer = o(function () {
					this.state = Bt, this.tryEmit()
				}, e.time, this);
				else if (t.eventType & pt) return Bt;
				return 32
			},
			reset: function () {
			...
			emit: function (t) {
				this.state === Bt && (t && t.eventType & pt ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = it(), this.manager.emit(this.options.event, this._input)))
			}
		}), c(Q, $, {
			defaults: {
				event: "rotate",
			...
			attrTest: function (t) {
				...
				return i & (bt | wt) ? e = t.velocity : i & bt ? e = t.velocityX : i & wt && (e = t.velocityY), this._super.attrTest.call(this, t) && i & t.direction && t.distance > this.options.threshold && et(e) > this.options.velocity && t.eventType & pt
			},
			emit: function (t) {
				var e = L(t.direction);
			...
			process: function (t) {
				var e = this.options,
					...
					n = t.distance < e.threshold,
					a = t.deltaTime < e.time;
				if (this.reset(), t.eventType & ut && 0 === this.count) return this.failTimeout();
				if (n && a && i) {
					if (t.eventType != pt) return this.failTimeout();
					var r = !this.pTime || t.timeStamp - this.pTime < e.interval,
						s = !this.pCenter || E(this.pCenter, t.center) < e.posThreshold;
			...
			recognize: function (t) {
				...
				if (!e.stopped) {
					...
					for (var a = 0; a < n.length;) i = n[a], 2 === e.stopped || o && i != o && !i.canRecognizeWith(o) ? i.reset() : i.recognize(t), !o && i.state & (Xt | Rt | Yt) && (o = e.curRecognizer = i), a++
				}
			},
			get: function (t) {
			...
			return Y
		}) : "undefined" != typeof module && module.exports ? module.exports = Y : t.Hammer = Y
	}(window, document),
	function (t) {
...
Materialize.throttle = function (t, e, i) {
	...
	function (t) {
		t.fn.collapsible = function (e, i) {
			...
			return e = t.extend({
				...
				function o(e) {
					d = u.find("> li > .collapsible-header"), e.hasClass("active") ? e.parent().addClass("active") : e.parent().removeClass("active"), e.parent().hasClass("active") ? e.siblings(".collapsible-body").stop(!0, !1).slideDown({
						duration: 350,
						easing: "easeOutQuart",
						queue: !1,
						complete: function () {
					...
					}), d.not(e).removeClass("active").parent().removeClass("active"), d.not(e).parent().children(".collapsible-body").stop(!0, !1).each(function () {
				...
				function r(t, i) {
					i || t.toggleClass("active"), e.accordion || "accordion" === p || void 0 === p ? o(t) : a(t), s(t)
				}
				...
				var u = t(this),
					d = t(this).find("> li > .collapsible-header"),
					p = u.data("collapsible");
				if ("destroy" !== n)
					if (i >= 0 && i < d.length) {
						var h = d.eq(i);
						h.length && ("open" === n || "close" === n && h.hasClass("active")) && r(h)
					} else c(), u.on("click.collapse", "> li > .collapsible-header", function (e) {
						var i = t(e.target);
						(function (t) {
							return l(t).length > 0
						})(i) && (i = l(i)), r(i)
					}), e.accordion || "accordion" === p || void 0 === p ? r(d.filter(".active").first(), !0) : d.filter(".active").each(function () {
						r(t(this), !0)
					});
				else c()
			})
			...
			return this.each(function () {
				...
				if (!t(this).hasClass("initialized")) {
					...
					s.wrap(l), s.on("click", function () {
						...
						if (!1 === a) return e(), !1;
						if (o && !0 === a) return e(), !1;
						for (a = !1, s.addClass("active"), o = !0, r.css({
							...
							var p = t(n);
							"visible" !== p.css("overflow") && (p.css("overflow-y", "visible"), i = void 0 === i ? p : i.add(p)), n = n.parentNode
						}
						s.css({
							position: "absolute",
							"z-index": 1e3,
			...
			init: function (e) {
				...
				return this.each(function (n) {
					var o, a, r, s, l = i + n,
						...
						p = c.width(),
						h = t(),
						f = Math.max(p, c[0].scrollWidth) / d.length,
						v = 0,
						m = 0,
						g = !1,
						y = function (t) {
							return Math.ceil(p - t.position().left - t[0].getBoundingClientRect().width - c.scrollLeft())
						},
						b = function (t) {
					...
					e.swipeable && u > e.responsiveThreshold && (e.swipeable = !1), 0 === (o = t(d.filter('[href="' + location.hash + '"]'))).length && (o = t(this).find("li.tab a.active").first()), 0 === o.length && (o = t(this).find("li.tab a").first()), o.addClass("active"), (v = d.index(o)) < 0 && (v = 0), void 0 !== o[0] && (a = t(o[0].hash)).addClass("active"), c.find(".indicator").length || c.append('<li class="indicator"></li>'), s = c.find(".indicator"), c.append(s), c.is(":visible") && setTimeout(function () {
					...
					}), r = h.wrapAll('<div class="tabs-content carousel"></div>'), h.css("display", ""), t(".tabs-content.carousel").carousel({
						fullWidth: !0,
						noWrap: !0,
						onCycleTo: function (t) {
							if (!g) {
								var i = v;
								v = r.index(t), o.removeClass("active"), (o = d.eq(v)).addClass("active"), w(i), "function" == typeof e.onShow && e.onShow.call(c[0], a)
							}
						}
						...
						if (t(this).parent().hasClass("disabled")) i.preventDefault();
							...
							g = !0, p = c.width(), f = Math.max(p, c[0].scrollWidth) / d.length, o.removeClass("active");
							var n = a;
							o = t(this), a = t(Materialize.escapeHash(this.hash)), d = c.find("li.tab a"), o.position(), o.addClass("active"), m = v, (v = d.index(t(this))) < 0 && (v = 0), e.swipeable ? h.length && h.carousel("set", v, function () {
								"function" == typeof e.onShow && e.onShow.call(c[0], a)
							}) : (void 0 !== a && (a.show(), a.addClass("active"), "function" == typeof e.onShow && e.onShow.call(this, a)), void 0 === n || n.is(a) || (n.hide(), n.removeClass("active"))), setTimeout(function () {
								g = !1
							}, 300), w(m), i.preventDefault()
						}
					})
				})
			},
		...
		t.fn.tooltip = function (i) {
			return "remove" === i ? (this.each(function () {
				...
				var a, r, s, l, c, u, d = function () {
					a = o.attr("data-html") ? "true" === o.attr("data-html") : i.html, r = void 0 === (r = o.attr("data-delay")) || "" === r ? i.delay : r, s = void 0 === (s = o.attr("data-position")) || "" === s ? i.position : s, l = void 0 === (l = o.attr("data-tooltip")) || "" === l ? i.tooltip : l
				};
				d(), c = function () {
				...
				o.on({
					"mouseenter.tooltip": function (t) {
						p = setTimeout(function () {
							...
							var t, i, n, a, r, l, p = o.outerWidth(),
								f = o.outerHeight(),
								v = c.outerHeight(),
								m = c.outerWidth(),
								g = "0px",
								...
								b = u[0].offsetWidth,
								w = u[0].offsetHeight;
							"top" === s ? (t = o.offset().top - v - 5, i = o.offset().left + p / 2 - m / 2, n = e(i, t, m, v), g = "-10px", u.css({
								bottom: 0,
								left: 0,
								...
								marginTop: v,
								marginLeft: m / 2 - b / 2
							})) : "left" === s ? (t = o.offset().top + f / 2 - v / 2, i = o.offset().left - m - 5, n = e(i, t, m, v), y = "-10px", u.css({
								top: "-7px",
								right: 0,
								width: "14px",
								height: "14px",
								...
								marginTop: v / 2,
								marginLeft: m
							})) : "right" === s ? (t = o.offset().top + f / 2 - v / 2, i = o.offset().left + p + 5, n = e(i, t, m, v), y = "+10px", u.css({
								top: "-7px",
								left: 0,
								width: "14px",
								height: "14px",
								...
								marginTop: v / 2,
								marginLeft: "0px"
							})) : (t = o.offset().top + o.outerHeight() + 5, i = o.offset().left + p / 2 - m / 2, n = e(i, t, m, v), g = "+10px", u.css({
								top: 0,
								left: 0,
								marginLeft: m / 2 - b / 2
							})), c.css({
								top: n.y,
								left: n.x
							}), a = Math.SQRT2 * m / parseInt(b), r = Math.SQRT2 * v / parseInt(w), l = Math.max(a, r), c.velocity({
								translateY: g,
								translateX: y
							}, {
								duration: 350,
	...
	function (t) {
		...
		function i(e) {
			...
			null !== i && (a.show(e, i), "ontouchstart" in t && (i.addEventListener("touchend", a.hide, !1), i.addEventListener("touchcancel", a.hide, !1)), i.addEventListener("mouseup", a.hide, !1), i.addEventListener("mouseleave", a.hide, !1), i.addEventListener("dragend", a.hide, !1))
		}
		var n = n || {},
			...
			a = {
				...
				show: function (t, i) {
					...
					o.className = o.className + " waves-notransition", o.setAttribute("style", e(u)), o.className = o.className.replace("waves-notransition", ""), u["-webkit-transform"] = c, u["-moz-transform"] = c, u["-ms-transform"] = c, u["-o-transform"] = c, u.transform = c, u.opacity = "1", u["-webkit-transition-duration"] = a.duration + "ms", u["-moz-transition-duration"] = a.duration + "ms", u["-o-transition-duration"] = a.duration + "ms", u["transition-duration"] = a.duration + "ms", u["-webkit-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", u["-moz-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", u["-o-transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", u["transition-timing-function"] = "cubic-bezier(0.250, 0.460, 0.450, 0.940)", o.setAttribute("style", e(u))
				},
				hide: function (t) {
					r.touchup(t);
					var i = this,
		...
		n.displayEffect = function (e) {
			"duration" in (e = e || {}) && (a.duration = e.duration), a.wrapInput(o(".waves-effect")), "ontouchstart" in t && document.body.addEventListener("touchstart", i, !1), document.body.addEventListener("mousedown", i, !1)
		}, n.attach = function (e) {
			"input" === e.tagName.toLowerCase() && (a.wrapInput([e]), e = e.parentNode), "ontouchstart" in t && e.addEventListener("touchstart", i, !1), e.addEventListener("mousedown", i, !1)
					...
					value: function () {
						...
						if (e.classList.add("toast"), this.options.className) {
							var i, o = this.options.className.split(" "),
								a = void 0;
							for (a = 0, i = o.length; a < i; a++) e.classList.add(o[a])
						}
			...
			init: function (e) {
				e = t.extend({
					...
					e.draggable ? (a.length && a.remove(), a = t('<div class="drag-target"></div>').attr("data-sidenav", n), t("body").append(a)) : a = t(), "left" == e.edge ? (o.css("transform", "translateX(-100%)"), a.css({
						...
						window.innerWidth > 992 ? 0 !== t("#sidenav-overlay").length && s ? r(!0) : o.css("transform", "translateX(0%)") : !1 === s && ("left" === e.edge ? o.css("transform", "translateX(-100%)") : o.css("transform", "translateX(100%)"))
					...
					e.draggable && (a.on("click", function () {
						...
						if ("touch" == i.gesture.pointerType) {
							...
							if (i.gesture.velocityX, 0 === n && 0 === a) return;
							var l, c = t("body"),
								u = t("#sidenav-overlay"),
								d = c.innerWidth();
							if (c.css("overflow", "hidden"), c.width(d), 0 === u.length && ((u = t('<div id="sidenav-overlay"></div>')).css("opacity", 0).click(function () {
									r()
								}), "function" == typeof e.onOpen && e.onOpen.call(this, o), t("body").append(u)), "left" === e.edge && (n > e.menuWidth ? n = e.menuWidth : n < 0 && (n = 0)), "left" === e.edge) n < e.menuWidth / 2 ? s = !1 : n >= e.menuWidth / 2 && (s = !0), o.css("transform", "translateX(" + (n - e.menuWidth) + "px)");
							else {
								n < window.innerWidth - e.menuWidth / 2 ? s = !0 : n >= window.innerWidth - e.menuWidth / 2 && (s = !1);
								var p = n - e.menuWidth / 2;
								p < 0 && (p = 0), o.css("transform", "translateX(" + p + "px)")
							}
							"left" === e.edge ? (l = n / e.menuWidth, u.velocity({
								opacity: l
							}, {
								duration: 10,
								queue: !1,
								easing: "easeOutQuad"
							})) : (l = Math.abs((n - window.innerWidth) / e.menuWidth), u.velocity({
								opacity: l
							}, {
								duration: 10,
								queue: !1,
						...
						if ("touch" == i.gesture.pointerType) {
							var n = t("#sidenav-overlay"),
								...
								c = l - e.menuWidth,
								u = l - e.menuWidth / 2;
							c > 0 && (c = 0), u < 0 && (u = 0), !1, "left" === e.edge ? s && r <= .3 || r < -.5 ? (0 !== c && o.velocity({
								translateX: [0, c]
							}, {
								duration: 300,
								queue: !1,
	...
	function (t) {
		...
		t.scrollSpy = function (e, n) {
			...
			return s || (o.on("scroll", u), o.on("resize", u), s = !0), setTimeout(u, 0), e.on("scrollSpy:enter", function () {
				r = t.grep(r, function (t) {
					return 0 != t.height()
				});
				var e = t(this);
				r[0] ? (t(n.getActiveElement(r[0].attr("id"))).removeClass(n.activeClass), e.data("scrollSpy:id") < r[0].data("scrollSpy:id") ? r.unshift(t(this)) : r.push(t(this))) : r.push(t(this)), t(n.getActiveElement(r[0].attr("id"))).addClass(n.activeClass)
			}), e.on("scrollSpy:exit", function () {
				if ((r = t.grep(r, function (t) {
						return 0 != t.height()
					}))[0]) {
					t(n.getActiveElement(r[0].attr("id"))).removeClass(n.activeClass);
					var e = t(this);
					(r = t.grep(r, function (t) {
						return t.attr("id") != e.attr("id")
					}))[0] && t(n.getActiveElement(r[0].attr("id"))).addClass(n.activeClass)
				}
			}), e
	...
	function (t) {
		t(document).ready(function () {
			...
			i.length || (i = t('<div class="hiddendiv common"></div>'), t("body").append(i)), t(".materialize-textarea").each(function () {
				var e = t(this);
				...
				! function (e) {
					var n = e.css("font-family"),
						...
						a = e.css("line-height"),
						r = e.css("padding");
					o && i.css("font-size", o), n && i.css("font-family", n), a && i.css("line-height", a), r && i.css("padding", r), e.data("original-height") || e.data("original-height", e.height()), "off" === e.attr("wrap") && i.css("overflow-wrap", "normal").css("white-space", "pre"), i.text(e.val() + "\n");
					var s = i.html().replace(/\n/g, "<br>");
					i.html(s), e.is(":visible") ? i.css("width", e.width()) : i.css("width", t(window).width() / 2), e.data("original-height") <= i.height() ? e.css("height", i.height()) : e.val().length < e.data("previous-length") && e.css("height", e.data("original-height")), e.data("previous-length", e.val().length)
				}(t(this))
			...
			t(document).on("change", n, function (e) {
				...
				i.find(".value").html(t(this).val()), i.hasClass("active") || a(i);
				var n = r(t(this));
				i.addClass("active").css("left", n)
			}), t(document).on("mousedown touchstart", n, function (e) {
				var i = t(this).siblings(".thumb");
				if (i.length <= 0 && (i = t('<span class="thumb"><span class="value"></span></span>'), t(this).after(i)), i.find(".value").html(t(this).val()), o = !0, t(this).addClass("active"), i.hasClass("active") || a(i), "input" !== e.type) {
					var n = r(t(this));
					i.addClass("active").css("left", n)
				}
				...
				return e = t.extend({
					...
					if (t.isEmptyObject(o)) n.off("keyup.autocomplete focus.autocomplete");
						...
						var u = function (t, e) {
							...
							d = function () {
								c.empty(), r = -1, c.find(".active").removeClass("active"), i = void 0
							};
						n.off("blur.autocomplete").on("blur.autocomplete", function () {
							...
							if (13 !== r.which && 38 !== r.which && 40 !== r.which) {
								if (i !== s && (d(), s.length >= e.minLength))
									for (var l in o)
										if (o.hasOwnProperty(l) && -1 !== l.toLowerCase().indexOf(s)) {
											if (a >= e.limit) break;
											var p = t("<li></li>");
											o[l] ? p.append('<img src="' + o[l] + '" class="right circle"><span>' + l + "</span>") : p.append("<span>" + l + "</span>"), c.append(p), u(s, p), a++
										}
								i = s
							}
							...
							n.val(i), n.trigger("change"), d(), "function" == typeof e.onAutocomplete && e.onAutocomplete.call(this, i)
						})
					}
				})
			}
							...
							if (40 != e.which || l.is(":visible")) {
								if (13 != e.which || l.is(":visible")) {
									...
									if (13 == e.which) {
										...
										r && (t(r).trigger("click"), o || m.trigger("close"))
									}
									40 == e.which && (a = l.find("li.selected").length ? l.find("li.selected").next("li:not(.disabled)")[0] : l.find("li:not(.disabled)")[0], g(l, a)), 27 == e.which && m.trigger("close"), 38 == e.which && (a = l.find("li.selected").prev("li:not(.disabled)")[0]) && g(l, a), setTimeout(function () {
										y = []
									}, 1e3)
								}
							} else m.trigger("open");
					...
					s.hammer({
						...
						if ("touch" === t.gesture.pointerType) {
							...
							var e, i = t.gesture.direction,
								...
								a = t.gesture.velocityY;
							$curr_slide = l.find(".active"), Math.abs(o) > Math.abs(a) && $curr_slide.velocity({
								translateX: n
							}, {
								duration: 50,
								queue: !1,
								easing: "easeOutQuad"
							}), 4 === i && (n > s.innerWidth() / 2 || o < -.65) ? p = !0 : 2 === i && (n < -1 * s.innerWidth() / 2 || o > .65) && (d = !0), d && (0 === (e = $curr_slide.next()).length && (e = c.first()), e.velocity({
								opacity: 1
							}, {
								duration: 300,
								queue: !1,
						...
						"touch" === t.gesture.pointerType && ($curr_slide = l.find(".active"), !1, curr_index = l.find(".active").index(), !p && !d || c.length <= 1 ? $curr_slide.velocity({
							translateX: 0
						}, {
							duration: 300,
							queue: !1,
						...
						})), d = !1, p = !1, clearInterval(r), r = setInterval(function () {
							u = l.find(".active").index(), c.length == u + 1 ? u = 0 : u += 1, n(u)
						}, e.transition + e.interval))
	...
	function (t) {
		...
		var e = function (e) {
			...
			i = function (t) {
				var e, i, n = t;
				!0 === n.hasClass("horizontal") ? i = 40 : e = 40, n.removeClass("active"), n.find("ul .btn-floating").velocity("stop", !0), n.find("ul .btn-floating").velocity({
					opacity: "0",
					scaleX: ".4",
					scaleY: ".4",
					translateY: e + "px",
			...
			o = function (t) {
				if ("true" === t.attr("data-open")) {
					...
					e = s - n / 2 + a / 2, i = o - r, u.width(), t.removeClass("active"), t.attr("data-open", !1), t.css({
			...
			t(".dismissable").each(function () {
				t(this).hammer({
					...
					if (Math.abs(n.gesture.deltaX) < t(this).innerWidth() / 2 && (i = !1, e = !1), "touch" === n.gesture.pointerType) {
						var o, a = t(this);
						if (e || i) o = e ? a.innerWidth() : -1 * a.innerWidth(), a.velocity({
							translateX: o
						}, {
							duration: 100,
							queue: !1,
	...
	function (t) {
		...
		function e(o, r, c, u) {
			function d() {
				return e._.node("div", e._.node("div", e._.node("div", e._.node("div", w.component.nodes(v.open), g.box), g.wrap), g.frame), g.holder)
			}
			...
			function p(t) {
				...
				(32 == e || i || !v.open && w.component.key[e]) && (t.preventDefault(), t.stopPropagation(), i ? w.clear().close() : w.open())
			}

			function h(t) {
				t.stopPropagation(), "focus" == t.type && w.$root.addClass(g.focused), w.open()
			}
			if (!o) return e;
			var f = !1,
				v = {
				...
				m = c ? t.extend(!0, {}, c.defaults, u) : u || {},
				g = t.extend({}, e.klasses(), m.klass),
				y = t(o),
				b = function () {
					return this.start()
				},
				w = b.prototype = {
					...
					$node: y,
					start: function () {
						return v && v.start ? w : (v.methods = {}, v.start = !0, v.open = !1, v.type = o.type, o.autofocus = o == a(), o.readOnly = !m.editable, o.id = o.id || v.id, "text" != o.type && (o.type = "text"), w.component = new c(w, m), w.$root = t(e._.node("div", d(), g.picker, 'id="' + o.id + '_root" tabindex="0"')), w.$root.on({
							keydown: p,
							focusin: function (t) {
								w.$root.removeClass(g.focused), t.stopPropagation()
							},
							...
							blur: function () {
								y.removeClass(g.target)
							}
						}).on("focus.toOpen", h).on("click", "[data-pick], [data-nav], [data-clear], [data-close]", function () {
							var e = t(this),
								i = e.data(),
								n = e.hasClass(g.navDisabled) || e.hasClass(g.disabled),
								o = a();
							o = o && (o.type || o.href) && o, (n || o && !t.contains(w.$root[0], o)) && w.$root.eq(0).focus(), !n && i.nav ? w.set("highlight", w.component.item.highlight, {
								nav: i.nav
							}) : !n && "pick" in i ? (w.set("select", i.pick), m.closeOnSelect && w.close(!0)) : i.clear ? (w.clear(), m.closeOnSelect && w.close(!0)) : i.close && w.close(!0)
						}), n(w.$root[0], "hidden", !0), m.formatSubmit && function () {
							var e;
							!0 === m.hiddenName ? (e = o.name, o.name = "") : e = (e = ["string" == typeof m.hiddenPrefix ? m.hiddenPrefix : "", "string" == typeof m.hiddenSuffix ? m.hiddenSuffix : "_submit"])[0] + o.name + e[1], w._hidden = t('<input type=hidden name="' + e + '"' + (y.data("value") || o.value ? ' value="' + w.get("select", m.formatSubmit) + '"' : "") + ">")[0], y.on("change." + v.id, function () {
								w._hidden.value = o.value ? w.get("select", m.formatSubmit) : ""
							}), m.container ? t(m.container).append(w._hidden) : y.before(w._hidden)
						}(), y.data(r, w).addClass(g.input).attr("tabindex", -1).val(y.data("value") ? w.get("select", m.format) : o.value), m.editable || y.on("focus." + v.id + " click." + v.id, function (t) {
							...
							readonly: !1,
							owns: o.id + "_root"
						}), m.container ? t(m.container).append(w.$root) : y.before(w.$root), w.on({
					...
					render: function (t) {
						return t ? w.$root.html(d()) : w.$root.find("." + g.box).html(w.component.nodes(v.open)), w.trigger("render")
					},
					stop: function () {
						return v.start ? (w.close(), w._hidden && w._hidden.parentNode.removeChild(w._hidden), w.$root.remove(), y.removeClass(g.input).removeData(r), setTimeout(function () {
							y.off("." + v.id)
						}, 0), o.type = v.type, o.readOnly = !1, w.trigger("stop"), v.methods = {}, v.start = !1, w) : w
					},
					open: function (a) {
						return v.open ? w : (y.addClass(g.active), n(o, "expanded", !0), setTimeout(function () {
							w.$root.addClass(g.opened), n(w.$root[0], "hidden", !1)
						}, 0), !1 !== a && (v.open = !0, f && l.css("overflow", "hidden").css("padding-right", "+=" + i()), w.$root.eq(0).focus(), s.on("click." + v.id + " focusin." + v.id, function (t) {
							var e = t.target;
							...
							var n = i.keyCode,
								o = w.component.key[n],
								a = i.target;
							27 == n ? w.close(!0) : a != w.$root[0] || !o && 13 != n ? t.contains(w.$root[0], a) && 13 == n && (i.preventDefault(), a.click()) : (i.preventDefault(), o ? e._.trigger(w.component.key.go, w, [e._.trigger(o)]) : w.$root.find("." + g.highlighted).hasClass(g.disabled) || (w.set("select", w.component.item.highlight), m.closeOnSelect && w.close(!0)))
						})), w.trigger("open"))
					},
					close: function (t) {
						return t && (w.$root.off("focus.toOpen").eq(0).focus(), setTimeout(function () {
							w.$root.on("focus.toOpen", h)
						}, 0)), y.removeClass(g.active), n(o, "expanded", !1), setTimeout(function () {
							w.$root.removeClass(g.opened + " " + g.focused), n(w.$root[0], "hidden", !0)
						}, 0), v.open ? (v.open = !1, f && l.css("overflow", "").css("padding-right", "-=" + i()), s.off("." + v.id), w.trigger("close")) : w
					},
					clear: function (t) {
					...
					set: function (e, i, n) {
						...
						if (n = r && t.isPlainObject(i) ? i : n || {}, e) {
							for (o in r || (s[e] = i), s) a = s[o], o in w.component.item && (void 0 === a && (a = null), w.component.set(o, a, n)), "select" != o && "clear" != o || y.val("clear" == o ? "" : w.get(o, m.format)).trigger("change");
							w.render()
						}
						return n.muted ? w : w.trigger("set", s)
					},
					get: function (t, i) {
					...
					on: function (e, i, n) {
						var o, a, r = t.isPlainObject(e),
							s = r ? e : {};
						if (e)
							for (o in r || (s[e] = i), s) a = s[o], n && (o = "_" + o), v.methods[o] = v.methods[o] || [], v.methods[o].push(a);
						return w
					},
					off: function () {
						var t, e, i = arguments;
	...
	function (t, e) {
		...
		i.prototype.set = function (t, e, i) {
			...
			var a, r = this;
			return (i = void 0 === i ? t : i) == -1 / 0 || i == 1 / 0 ? a = i : e.isPlainObject(i) && n.isInteger(i.pick) ? i = i.obj : e.isArray(i) ? (i = new Date(i[0], i[1], i[2]), i = n.isDate(i) ? i : r.create().obj) : i = n.isInteger(i) || n.isDate(i) ? r.normalize(new Date(i), o) : r.now(t, i, o), {
			...
			var e = this,
				...
				f = function (o) {
					...
					return "short_months" == o && (a = i.monthsShort), i.selectMonths && null == o ? n.node("select", n.group({
						min: 0,
						max: 11,
						i: 1,
						node: "option",
				...
				v = function (o) {
					...
					if (s) {
						...
						if (i.selectYears && null == o) return n.node("select", n.group({
							min: h,
							max: f,
							i: 1,
							node: "option",
			...
			return createDayLabel = function () {
				return null != r ? r.date + " de " : a.date
			}, createWeekdayLabel = function () {
				var t;
				return t = null != r ? r.day : a.day, i.weekdaysShort[t]
			}, n.node("div", n.node("div", v("raw"), i.klass.year_display) + n.node("span", createDayLabel(), i.klass.day_display) + n.node("span", createWeekdayLabel() + ", ", "picker__weekday-display") + n.node("span", f("short_months") + " ", i.klass.month_display), i.klass.date_display) + n.node("div", n.node("div", n.node("div", (i.selectYears, f() + v() + h() + h(1)), i.klass.header) + n.node("table", p + n.node("tbody", n.group({
				min: 0,
				max: 5,
				i: 1,
				node: "tr",
	...
	function (t) {
		...
		o.DEFAULTS = {
			...
			var t = this.element,
				e = this.popover;
			t.offset(), t.outerWidth(), t.outerHeight(), this.options.align, e.show()
			...
			var r, s = Math.atan2(e, -n),
				...
				h = l && d < (y + b) / 2,
				f = h ? b : y;
			if (p.twelvehour && (f = y), s < 0 && (s = 2 * Math.PI + s), s = (r = Math.round(s / u)) * u, p.twelvehour ? l ? 0 === r && (r = 12) : (o && (r *= 5), 60 === r && (r = 0)) : l ? (12 === r && (r = 0), r = h ? 0 === r ? 12 : r : 0 === r ? 0 : r + 12) : (o && (r *= 5), 60 === r && (r = 0)), this[this.currentView] !== r && v && this.options.vibrate && (this.vibrateTimer || (navigator[v](10), this.vibrateTimer = setTimeout(t.proxy(function () {
	...
	function (t) {
		...
		t.fn.characterCounter = function () {
			return this.each(function () {
				var n = t(this);
				n.parent().find('span[class="character-counter"]').length || void 0 !== n.attr("data-length") && (n.on("input", e), n.on("focus", e), n.on("blur", i), function (e) {
		...
		var e = {
			init: function (e) {
				...
				return this.each(function (n) {
					...
					function r(t) {
						return t >= x ? t % x : t < 0 ? r(x + t % x) : t
					}

					function s(i) {
						!0, H.hasClass("scrolling") || H.addClass("scrolling"), null != z && window.clearTimeout(z), z = window.setTimeout(function () {
							!1, H.removeClass("scrolling")
						}, e.duration);
						var n, o, a, s, l, c, u, d = b;
						if (g = "number" == typeof i ? i : g, b = Math.floor((g + k / 2) / k), l = -(s = (a = g - b * k) < 0 ? 1 : -1) * a * 2 / k, o = x >> 1, e.fullWidth ? u = "translateX(0)" : (u = "translateX(" + (H[0].clientWidth - v) / 2 + "px) ", u += "translateY(" + (H[0].clientHeight - m) / 2 + "px)"), j) {
							var p = b % x,
								h = q.find(".indicator-item.active");
							h.index() !== p && (h.removeClass("active"), q.find(".indicator-item").eq(p).addClass("active"))
						}
						for ((!$ || b >= 0 && b < x) && (c = f[r(b)], t(c).hasClass("active") || (H.find(".carousel-item").removeClass("active"), t(c).addClass("active")), c.style[O] = u + " translateX(" + -a / 2 + "px) translateX(" + s * e.shift * l * n + "px) translateZ(" + e.dist * l + "px)", c.style.zIndex = 0, e.fullWidth ? tweenedOpacity = 1 : tweenedOpacity = 1 - .2 * l, c.style.opacity = tweenedOpacity, c.style.display = "block"), n = 1; n <= o; ++n) e.fullWidth ? (zTranslation = e.dist, tweenedOpacity = n === o && a < 0 ? 1 - l : 1) : (zTranslation = e.dist * (2 * n + l * s), tweenedOpacity = 1 - .2 * (2 * n + l * s)), (!$ || b + n < x) && ((c = f[r(b + n)]).style[O] = u + " translateX(" + (e.shift + (k * n - a) / 2) + "px) translateZ(" + zTranslation + "px)", c.style.zIndex = -n, c.style.opacity = tweenedOpacity, c.style.display = "block"), e.fullWidth ? (zTranslation = e.dist, tweenedOpacity = n === o && a > 0 ? 1 - l : 1) : (zTranslation = e.dist * (2 * n - l * s), tweenedOpacity = 1 - .2 * (2 * n - l * s)), (!$ || b - n >= 0) && ((c = f[r(b - n)]).style[O] = u + " translateX(" + (-e.shift + (-k * n - a) / 2) + "px) translateZ(" + zTranslation + "px)", c.style.zIndex = -n, c.style.opacity = tweenedOpacity, c.style.display = "block");
						if ((!$ || b >= 0 && b < x) && ((c = f[r(b)]).style[O] = u + " translateX(" + -a / 2 + "px) translateX(" + s * e.shift * l + "px) translateZ(" + e.dist * l + "px)", c.style.zIndex = 0, e.fullWidth ? tweenedOpacity = 1 : tweenedOpacity = 1 - .2 * l, c.style.opacity = tweenedOpacity, c.style.display = "block"), d !== b && "function" == typeof e.onCycleTo) {
							var y = H.find(".carousel-item").eq(r(b));
							e.onCycleTo.call(this, y, I)
						}
						"function" == typeof V && (V.call(this, y, I), V = null)
					}

					function l() {
						var t, e, i;
						e = (t = Date.now()) - _, _ = t, i = g - E, E = g, A = 1e3 * i / (1 + e) * .8 + .2 * A
					}

					function c() {
						var t, i;
						S && (t = Date.now() - _, (i = S * Math.exp(-t / e.duration)) > 2 || i < -2 ? (s(P - i), requestAnimationFrame(c)) : s(P))
					}

					function u(t) {
						var e = b % x - t;
						$ || (e < 0 ? Math.abs(e + x) < Math.abs(e) && (e += x) : e > 0 && Math.abs(e - x) < e && (e -= x)), e < 0 ? H.trigger("carouselNext", [Math.abs(e)]) : e > 0 && H.trigger("carouselPrev", [e])
					}

					function d(e) {
						"mousedown" === e.type && t(e.target).is("img") && e.preventDefault(), w = !0, I = !1, D = !1, C = o(e), T = a(e), A = S = 0, E = g, _ = Date.now(), clearInterval(M), M = setInterval(l, 100)
					}

					function p(t) {
						var e, i;
						if (w)
							if (e = o(t), y = a(t), i = C - e, Math.abs(T - y) < 30 && !D)(i > 2 || i < -2) && (I = !0, C = e, s(g + i));
							else {
					...
					function h(t) {
						if (w) return w = !1, clearInterval(M), P = g, (A > 10 || A < -10) && (P = g + (S = .9 * A)), P = Math.round(P / k) * k, $ && (P >= k * (x - 1) ? P = k * (x - 1) : P < 0 && (P = 0)), S = P - g, _ = Date.now(), requestAnimationFrame(c), I && (t.preventDefault(), t.stopPropagation()), !1
					}
					var f, v, m, g, b, w, k, x, C, T, S, P, A, O, E, _, M, I, D, q = t('<ul class="indicators"></ul>'),
						z = null,
						V = null,
						H = t(this),
						L = H.find(".carousel-item").length > 1,
						j = (H.attr("data-indicators") || e.indicators) && L,
						$ = H.attr("data-no-wrap") || e.noWrap || !L,
						N = H.attr("data-namespace") || i + n;
					H.attr("data-namespace", N);
					var W = function (e) {
						var i = H.find(".carousel-item.active").length ? H.find(".carousel-item.active").first() : H.find(".carousel-item").first(),
							n = i.find("img").first();
						if (n.length)
							if (n[0].complete)
								if (n.height() > 0) H.css("height", n.height());
								else {
					...
					if (e.fullWidth && (e.dist = 0, W(), j && H.find(".carousel-fixed-item").addClass("with-indicators")), H.hasClass("initialized")) return t(window).trigger("resize"), H.trigger("carouselNext", [1e-6]), !0;
					H.addClass("initialized"), w = !1, g = P = 0, f = [], v = H.find(".carousel-item").first().innerWidth(), m = H.find(".carousel-item").first().innerHeight(), k = 2 * v + e.padding, H.find(".carousel-item").each(function (e) {
						if (f.push(t(this)[0]), j) {
							var i = t('<li class="indicator-item"></li>');
							0 === e && i.addClass("active"), i.click(function (e) {
								e.stopPropagation(), u(t(this).index())
							}), q.append(i)
						}
					}), j && H.append(q), x = f.length, O = "transform", ["webkit", "Moz", "O", "ms"].every(function (t) {
						var e = t + "Transform";
						return void 0 === document.body.style[e] || (O = e, !1)
					});
					var F = Materialize.throttle(function () {
						e.fullWidth ? (v = H.find(".carousel-item").first().innerWidth(), H.find(".carousel-item.active").height(), k = 2 * v + e.padding, P = g = 2 * b * v, W(!0)) : s()
					}, 200);
					t(window).off("resize.carousel-" + N).on("resize.carousel-" + N, F), void 0 !== window.ontouchstart && (H.on("touchstart.carousel", d), H.on("touchmove.carousel", p), H.on("touchend.carousel", h)), H.on("mousedown.carousel", d), H.on("mousemove.carousel", p), H.on("mouseup.carousel", h), H.on("mouseleave.carousel", h), H.on("click.carousel", function (i) {
						if (I) return i.preventDefault(), i.stopPropagation(), !1;
						if (!e.fullWidth) {
							var n = t(i.target).closest(".carousel-item").index();
							0 != r(b) - n && (i.preventDefault(), i.stopPropagation()), u(n)
						}
					}), s(g), t(this).on("carouselNext", function (t, e, i) {
						void 0 === e && (e = 1), "function" == typeof i && (V = i), P = k * Math.round(g / k) + k * e, g !== P && (S = P - g, _ = Date.now(), requestAnimationFrame(c))
					}), t(this).on("carouselPrev", function (t, e, i) {
						void 0 === e && (e = 1), "function" == typeof i && (V = i), P = k * Math.round(g / k) - k * e, g !== P && (S = P - g, _ = Date.now(), requestAnimationFrame(c))
					}), t(this).on("carouselSet", function (t, e, i) {
						void 0 === e && (e = 0), "function" == typeof i && (V = i), u(e)
					})
				})
			},
			next: function (e, i) {
